...
export default function MainNavigation() {
    ...
    const bootstrap = async () => {
      ...
      try{
        let take;
        taken = await AsyncStorage.getItem('userToken')
        authContext.restoreToken(take);
    ...
    return (
        <Root>
            ...
            { isLoading ? <Stack.Screen name="Splash" component={SplashScreen} options={{ headerShown: false }} /> :
